...
debian_elk() {
    ...
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/logstash/logstash-6.4.0.deb
    # Install logstash debian package
    sudo dpkg -i /opt/logstash-6.4.0.deb
    # Downloading debian package of elasticsearch
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.4.0.deb
    # Install debian package of elasticsearch
    sudo dpkg -i /opt/elasticsearch-6.4.0.deb
    # install kibana
    sudo apt-get install apt-transport-https
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/kibana/kibana-6.4.0-amd64.deb
    sudo dpkg -i /opt/kibana-6.4.0-amd64.deb
...
rpm_elk() {
    ...
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/logstash/logstash-6.4.0.rpm
    # Install logstash rpm package
    sudo rpm -ivh /opt/logstash-6.4.0.rpm
    # Downloading rpm package of elasticsearch
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.4.0.rpm
    # Install rpm package of elasticsearch
    sudo rpm -ivh /opt/elasticsearch-6.4.0.rpm
    # Download kibana tarball in /opt
    sudo wget --directory-prefix=/opt/ https://artifacts.elastic.co/downloads/kibana/kibana-6.4.0-linux-x86_64.tar.gz
    # Extracting kibana tarball
    sudo tar zxf /opt/kibana-6.4.0-linux-x86_64.tar.gz -C /opt/
    # Starting The Services
    sudo service logstash start
    sudo service elasticsearch start
    sudo /opt/kibana-6.4.0-linux-x86_64/bin/kibana &
}
